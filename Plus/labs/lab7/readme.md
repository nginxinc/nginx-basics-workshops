...
1. Run below script to generate temporary self-signed certificates that would be used by NGINX OSS instances.Ensure you are in the `/lab7` folder:
...
(**NOTE:** Make sure you are within `labs/lab7` folder before running the command)
